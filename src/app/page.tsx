          ...
          <section>
            <Reveal>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/80">
                Huseyin Alsan is a Traffic Engineer working across road and
                street design, active travel, traffic modelling, traffic
            ...
            <Reveal delay={0.18}>
              <div>
                <h2 className="font-[var(--font-space-grotesk)] text-4xl font-bold leading-tight tracking-tight text-[#003C3F] md:text-5xl">
                  ...
                  transport infrastructure for the communities who use our
                  streets every day.
                </h2>
                ...
                <div className="mt-8 space-y-6 text-lg leading-8 text-slate-700">
                  <p>
                    ...
                    experience across road and street design, active travel,
                    public transport infrastructure, traffic modelling, traffic
                    signals and signage.
                  </p>
                  ...
                  <p>
                    My engineering approach is centred on practical,
                    evidence-led design decisions. I focus on making the best
                    use of often limited road space, particularly in dense urban
                    environments, while improving safety, accessibility and
                    usability.
                  </p>
            ...
            <Reveal>
              <div>
                ...
                <p className="mt-6 text-lg leading-8 text-white/80">
                  A transport and civil engineering background shaped by
                  highways, street design, active travel, traffic modelling,
                  railway engineering and infrastructure planning.
                </p>
              </div>
            </Reveal>
